...
def viewdb():
    ...
    """
    rows = execute_query("""
        SELECT FoodName, EaseOfMaking, Taste, DIET_LABEL (EaseOfMaking + Taste) AS TotalRating
        FROM FoodReviews.Food_Reviews, FoodReviews.Diatary_Class
        Where DiataryClass = DietID
